...
\setmainfont{Mrs Eaves}[
    AutoFakeSlant=0.2,
    SmallCapsFont={../fonts/mrs-eaves-small-caps-roman.otf},
    ItalicFont={Mrs Eaves OT},
    BoldItalicFont={Mrs Eaves XL Serif Nar OT}
]
\newfontfamily\italicfont{Mrs Eaves OT}
\newfontfamily\bolditalicfont{Mrs Eaves XL Serif Nar OT}
\newfontfamily\scitalicfont[Path=../fonts/]{mrs-eaves-small-caps-roman.otf}
\else
\newcommand{\italicfont}{\itshape}
\newcommand{\bolditalicfont}{\bfseries\itshape}
