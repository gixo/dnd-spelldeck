...
\usepackage{svg}
\usepackage{xstring}
\usepackage[paperheight=8.89cm,paperwidth=6.35cm,margin=0.3cm,top=19.5mm,bottom=0mm,headheight=12mm]{geometry}
...
\newenvironment{spell}[9]{
    ...
    \begin{minipage}[t][5.5cm][t]{\textwidth}  % Main content height
        \setlength{\parskip}{0.5em}%
        % Spell attributes section
        \leavevmode\begin{minipage}[t]{\textwidth}
